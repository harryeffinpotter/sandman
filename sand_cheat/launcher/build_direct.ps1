...
Write-Host "`n=== Direct Launcher Build ===" -ForegroundColor Cyan
...
cl /EHsc /O2 /MT /std:c++17 /Isrc /Icommon @sources launcher.res /Fe:sand_launcher_direct.exe /link @libs
...
Write-Host "`nBuild succeeded: sand_launcher_direct.exe" -ForegroundColor Green
